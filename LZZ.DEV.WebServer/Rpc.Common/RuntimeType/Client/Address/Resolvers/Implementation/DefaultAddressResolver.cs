...
using Rpc.Common.RuntimeType.Client.Address.Resolvers.Implementation.Selectors;
...
namespace Rpc.Common.RuntimeType.Client.Address.Resolvers.Implementation
{
    /// <summary>
    /// 一个人默认的服务地址解析器
    /// </summary>
